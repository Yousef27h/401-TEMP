...
public final class Account implements Model {
  ...
  public static final QueryField DESCRIPTION = field("Account", "description");
  ...
  private final @ModelField(targetType="Expense") @HasMany(associatedWith = "account", type = Expense.class) List<Expense> expences = null;
  ...
  private Account(String id, String name, String description, Double balance) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), account.getId()) &&
              ...
              ObjectsCompat.equals(getDescription(), account.getDescription()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Double balance) {
      super.id(id);
      super.name(name)
