...
public final class Expense implements Model {
  ...
  private final @ModelField(targetType="String") String cost;
  ...
  private Expense(String id, String name, String description, String cost) {
    this.id = id;
    this.name = name;
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    @Override
     public BuildStep cost(String cost) {
        this.cost = cost;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, String cost) {
      super.id(id);
      super.name(name)
    ...
    @Override
     public CopyOfBuilder cost(String cost) {
